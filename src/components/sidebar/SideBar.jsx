...
const SideBar = ({ openSideBar }) => {
  ...
  // ✅ Only the four options you asked
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <div
        className={`hidden md:flex flex-col bg-white border-r border-gray-200 h-screen relative transition-all duration-300 ease-in-out z-30 ${
          isExpanded ? "w-64" : "w-16"
        }`}
      >
        {/* Toggle Button */}
        <div className="flex justify-end p-4 pb-0" onClick={toggleSidebar}>
          <button
        ...
        {/* Navigation Options */}
        <nav
          className={`flex-1 mt-4 scrollbar scrollbar-thin ${
